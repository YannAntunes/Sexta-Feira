...
import br.com.yann.sextafeira.modes.finance.dto.*;
import br.com.yann.sextafeira.modes.finance.service.ChartsService;
...
public class ChartsController {
    ...
    public ResponseEntity<byte[]> orcamentoVsGastoPng() {
        ...
        var req = new ChartBudgetRequestDTO(titulo, items);
    ...
    public ResponseEntity<byte[]> evolucaoGastosMesPng() {
        ...
        var req = new ChartSerieRequestDTO(titulo, "R$", items);
